...
/* 
  DSP Roadmap
  1) figure out how to slpit the audio into 3 bands
  ...
  5) add 2 remaining compressor.
  6) add ability to mute/solo/bypass individual compressors.
  7) add input and output gain to offset chages in output level
...
namespace Params
{
  ...
  inline const std::map<Names, juce::String>& GetParams()
  {
      static std::map<Names, juce::String> params = {
          ...
          {Release_Low_Band,"Pelease Low Band"},
...
struct CompressorBand
{
  ...
  void prepare(const juce::dsp::ProcessorSpec& spec)
  {
    compressor.prepare(spec);
  }

  void updateCompressorSetting()
  {
...
/**
 */
class GenjutsuAudioProcessor : public juce::AudioProcessor
...
public:
  //==============================================================================
  GenjutsuAudioProcessor();
  ~GenjutsuAudioProcessor() override;
...
private:
  ...
  //==============================================================================
  JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(GenjutsuAudioProcessor)
};
